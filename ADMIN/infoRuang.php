...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="main-content">
                <a href="#" class="btn btn-primary mb-2" data-toggle="modal" data-target="#tambahruang"><i class="fas fa-plus-circle mr-2"></i>TAMBAH RUANGAN</a>
    ...
    SQL;
            ...
            <tr>
                ...
                <td>Ditempati</td>
                <td>
                    <a href='hapus_ruang.php?id=<?=$id_ruangan?>' onclick='return confirm("Apakah Anda yakin untuk menghapus?")'><i class='bg-danger p-2 text-white rounded'>Hapus</i></a>
