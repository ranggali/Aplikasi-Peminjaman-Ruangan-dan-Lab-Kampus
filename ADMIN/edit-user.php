                ...
                <form action="edit_user.php" method="post" role="form">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8"><input type="text" class="form-control" name="nama" placeholder="Nama" value="<?php echo $row['nama_lengkap']; ?>" required=""></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label class="col-sm-3 control-label text-right">id_user</label>
                            <div class="col-sm-8"><input type="text" class="form-control" name="nim" placeholder="Nim" value="<?php echo $row['id_user']; ?>" required readonly></div>
                            <div class="col-sm-8"><input type="hidden" class="form-control" name="id_user" placeholder="Nim" value="<?php echo $row['id_user']; ?>" ></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label class="col-sm-3 control-label text-right">Username</label>
                            <div class="col-sm-8"><input type="text" class="form-control" name="username" placeholder="Username" value="<?php echo $row['username']; ?>" required=""></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label class="col-sm-3 control-label text-right">Password</label>
                            <div class="col-sm-8"><input type="text" class="form-control" name="pass" placeholder="Password" id="alamat" value="<?php echo $row['password']; ?>" required="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8"><input type="text" class="form-control" name="prodi" placeholder="Prodi" id="alamat" value="<?php echo $row['prodi']; ?>" required="">
                            </div>
                        </div>
                    </div>
                    <a href="tambah_user.php" class="btn btn-danger">Kembali</a>
