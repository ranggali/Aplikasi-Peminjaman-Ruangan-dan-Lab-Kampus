...
<body>
    ...
    <div class="wrapper">
        ...
        JOIN user as p ON (p.id_user=d.id_user) WHERE d.id_user = '$nim_mhs'
    SQL;
                        $statement = $connection->query($sql);
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $selesai ?></td>
                                <td>
                                    <?php if ($status == 0) echo "menunggu";
                                    else if ($status == 1) echo "disetujui";
                                    else if ($status == 2) echo "ditolak"; 
                                    else echo "selesai";?>
                                </td>
                                <td>
                                    <a href='hapus_konfirmasi.php?id=<?= $id ?>' onclick='return confirm("Apakah Anda yakin untuk menghapus?")'><i class='bg-danger p-2 text-white rounded'>Hapus</i></a>
                                </td>
                            </tr>
